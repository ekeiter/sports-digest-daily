...
function FavoriteCard({ logoUrl, label, sublabel, secondaryIcon, secondaryLabel, onClick, onDelete }: FavoriteCardProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="relative flex flex-col items-center justify-center gap-0.5 w-full py-1.5 px-2 rounded-xl bg-card dark:bg-favorite-card hover:bg-accent/50 dark:hover:bg-favorite-card-hover transition-colors text-center shadow-[0_2px_8px_rgba(0,0,0,0.12)] dark:shadow-[0_6px_24px_rgba(255,255,255,0.15),_0_0_2px_rgba(255,255,255,0.25)] dark:text-[hsl(210_11%_15%)] select-none h-[118px]"
    >
