        ...
        <div className="bg-transparent border-none shadow-none">
          <div className="pt-2">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <Input 
                    ...
                    className="pr-8 bg-card text-base md:text-sm placeholder:text-sm" 
                  />
            ...
            {showSchoolsView ? <div className="space-y-3">
                ...
                return <div key={school.id} className="flex items-center gap-1.5 p-1 rounded-lg transition-colors border select-none bg-card dark:bg-favorite-card dark:text-[hsl(210_11%_15%)] dark:shadow-[0_6px_24px_rgba(255,255,255,0.15),_0_0_2px_rgba(255,255,255,0.25)] border-muted-foreground/40">
          ...
          <div className="space-y-2">
              ...
              return <div key={item.id}>
                      {showDivider && <div className="border-t border-muted-foreground/30 my-3" />}
                      <div className="flex items-center gap-1.5 py-0.5 px-1.5 rounded-lg border transition-colors select-none bg-card dark:bg-favorite-card dark:text-[hsl(210_11%_15%)] dark:shadow-[0_6px_24px_rgba(255,255,255,0.15),_0_0_2px_rgba(255,255,255,0.25)] border-muted-foreground/30">
                        <div onClick={() => {
                    ...
                    loadAllSchools();
                      ...
                      {/* Accordion children */}
                      {isAccordionParent && isAccordionExpanded && <div className="mt-1 rounded-lg border border-muted-foreground/30 bg-card dark:bg-favorite-card dark:text-[hsl(210_11%_15%)] dark:shadow-[0_6px_24px_rgba(255,255,255,0.15),_0_0_2px_rgba(255,255,255,0.25)] shadow-sm overflow-hidden">
                    ...
                    return <div key={child.id}>
                          ...
                          loadTeamsForLeague(child.entity_id!);
                            ...
                            return count > 0 ? ` (${count})` : '';
                                ...
                                {childHasChildren && childIsAccordionExpanded && <div className="mt-1 rounded-lg border border-muted-foreground/30 bg-card dark:bg-[hsl(210_10%_75%)] dark:text-[hsl(210_11%_15%)] dark:shadow-[0_6px_24px_rgba(255,255,255,0.15),_0_0_2px_rgba(255,255,255,0.25)] shadow-sm overflow-hidden">
                                    {/* Container header with logo and title */}
                                    <div className="flex items-center justify-center gap-2 py-2 px-3 border-b border-muted-foreground/20">
                                      {child.logo_url && <div className="flex items-center justify-center w-8 h-8 shrink-0 logo-glow">
                                          <img src={child.logo_url} alt={child.label} className="h-7 w-7 object-contain" onError={e => e.currentTarget.style.display = 'none'} />
