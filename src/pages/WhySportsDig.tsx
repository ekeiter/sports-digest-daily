      ...
      <main className="container mx-auto px-4 pb-6">
        <div className="bg-white rounded-lg shadow-lg p-5 md:p-6 space-y-6">
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-foreground">SportsDig updates coverage throughout the day.  Articles appear within minutes of publication, not hours. If news breaks, you see it fast.</p>
          </section>
