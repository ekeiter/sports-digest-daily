...
AS $function$
  ...
  SELECT 
    ...
    COALESCE(
      ...
      pmi_sport.logo_url,
      CASE p.sport_id
        WHEN 3 THEN 'https://zciaplmrcqlxxprgasqf.supabase.co/storage/v1/object/public/Logos/topics/football-png-25016.png'
        WHEN 5 THEN 'https://zciaplmrcqlxxprgasqf.supabase.co/storage/v1/object/public/Logos/topics/soccer-ball-png-26391.png'
        ELSE NULL
      END
    ) AS sport_logo_url,
