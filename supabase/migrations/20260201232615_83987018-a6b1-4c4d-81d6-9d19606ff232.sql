...
AS $$
  ...
  LEFT JOIN public.preference_menu_items pmi_sport 
    ON pmi_sport.entity_type = 'sport' AND pmi_sport.entity_id = p.sport_id
  LEFT JOIN public.preference_menu_items pmi_league 
    ON pmi_league.entity_type = 'league' AND pmi_league.entity_id = p.league_id
